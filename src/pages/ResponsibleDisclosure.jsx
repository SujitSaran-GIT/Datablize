    ...
    <div className={`min-h-screen ${themeConfig.background} py-12 px-4 sm:px-6 lg:px-8`}>
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <h1 className={`text-4xl font-bold ${themeConfig.textPrimary} mb-4`}>Datablize Responsible Disclosure Policy</h1>
          ...
          <div className={`${themeConfig.cardBackground} p-8 rounded-xl shadow-lg border ${themeConfig.border}`}>
            <div className="prose max-w-none">
              ...
              <motion.div
                ...
                className="mb-10"
              >
                <h2 className={`text-2xl font-bold ${themeConfig.textPrimary} mb-4 border-b ${themeConfig.border} pb-2`}>Scope</h2>
                <p className={`${themeConfig.textPrimary} mb-4`}>
                  This policy applies to the identification of potential security vulnerabilities found in:
                </p>
                <ul className={`list-disc pl-6 ${themeConfig.textPrimary} space-y-2`}>
              ...
              <motion.div
                ...
                className="mb-10"
              >
                <h2 className={`text-2xl font-bold ${themeConfig.textPrimary} mb-4 border-b ${themeConfig.border} pb-2`}>Good Faith Reporting</h2>
                <p className={`${themeConfig.textPrimary} mb-4`}>
                ...
                <div className={`${themeConfig.accentBackground} p-4 rounded-lg`}>
                  <p className={`${themeConfig.accentText}`}>
              ...
              <motion.div
                ...
                className="mb-10"
              >
                <h2 className={`text-2xl font-bold ${themeConfig.textPrimary} mb-4 border-b ${themeConfig.border} pb-2`}>Reporting Guidelines</h2>
                <p className={`${themeConfig.textPrimary} mb-4`}>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  {[
                    ...
                    <div key={index} className="flex items-start gap-3">
                      <div className={`${themeConfig.checkmarkBackground} p-1 rounded-full mt-1`}>
              ...
              <motion.div
                ...
                className="mb-10"
              >
                <h2 className={`text-2xl font-bold ${themeConfig.textPrimary} mb-4 border-b ${themeConfig.border} pb-2`}>How to Report</h2>
                <p className={`${themeConfig.textPrimary} mb-4`}>
                  Please send your findings to: <span className={`font-semibold ${themeConfig.accentText}`}>security@datablize.com</span>
                </p>
                <p className={`${themeConfig.textPrimary} mb-4`}>
                  Include the following details to help us investigate efficiently:
                </p>
                <ul className={`list-disc pl-6 ${themeConfig.textPrimary} space-y-2 mb-4`}>
              ...
              <motion.div
                ...
                className="mb-10"
              >
                <h2 className={`text-2xl font-bold ${themeConfig.textPrimary} mb-4 border-b ${themeConfig.border} pb-2`}>Our Commitment to Security Researchers</h2>
                <p className={`${themeConfig.textPrimary} mb-4`}>
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  {[
                    ...
                    <div key={index} className={`${themeConfig.accentBackground} p-4 rounded-lg`}>
                      <p className={`${themeConfig.accentText}`}>{item}</p>
                    </div>
                  ))}
                </div>
              </motion.div>
              ...
              <motion.div
                ...
                className="mb-10"
              >
                <h2 className={`text-2xl font-bold ${themeConfig.textPrimary} mb-4 border-b ${themeConfig.border} pb-2`}>Out-of-Scope Submissions</h2>
                <p className={`${themeConfig.textPrimary} mb-4`}>
              ...
              <motion.div
                ...
                className="mb-10"
              >
                <h2 className={`text-2xl font-bold ${themeConfig.textPrimary} mb-4 border-b ${themeConfig.border} pb-2`}>Legal Notice</h2>
                <p className={`${themeConfig.textPrimary} mb-4`}>
